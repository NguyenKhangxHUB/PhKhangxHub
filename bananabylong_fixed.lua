...
Volcanic:AddButton({
    Title = "🌋 Xoá Toàn Bộ Lava (Full Clean)",
    Callback = function()
        pcall(function()
            -- 1. Xoá InteriorLava model
            local core = game.Workspace.Map
                and game.Workspace.Map:FindFirstChild("PrehistoricIsland")
                and game.Workspace.Map.PrehistoricIsland:FindFirstChild("Core")
            if core then
                local interiorLava = core:FindFirstChild("InteriorLava")
                if interiorLava then interiorLava:Destroy() end

                -- 2. Xoá tất cả Part/MeshPart tên chứa "lava" trong PrehistoricIsland
                ...
                if prehistoricIsland then
                    for _, obj in pairs(prehistoricIsland:GetDescendants()) do
                        if (obj:IsA("Part") or obj:IsA("MeshPart") or obj:IsA("UnionOperation"))
            ...
            -- 3. Xoá "Lava" toàn workspace (tên đúng "Lava")
            ...
            -- 4. Xoá Fire/Smoke effect liên quan lava trong island
            local island = game.Workspace.Map and game.Workspace.Map:FindFirstChild("PrehistoricIsland")
            if island then
