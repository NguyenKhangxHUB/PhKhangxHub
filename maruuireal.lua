...
local ValidKey = "MARU-4WPUY-7881AO-0VU-VOOV6-FFO63"
local ValidId = "1367661813751222292"

if getgenv().Key ~= ValidKey or getgenv().id ~= ValidId then
    Players.LocalPlayer:Kick("[MARU HUB] Invalid Key/ID")
    return
end
