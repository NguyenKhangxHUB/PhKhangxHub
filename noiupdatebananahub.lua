...
EliteHunter:SetText("Elite Hunter: " .. eliteStatus)
            ...
            local cakeResult = SafeCall(function()
                return ReplicatedStorage.Remotes.CommF_:InvokeServer("CakePrinceSpawner")
            end, "")

            local cakeText = (#cakeResult < 86) and "Cake Prince: ✅"
                or ("Cake Prince: " .. tostring(string.sub(cakeResult, 39, 41)))
...
task.spawn(function()
    while true do
        ...
        local islands = {"Island 1","Island 2","Island 3","Island 4","Island5"}
        ...
        while _G.Raiding do
            ...
            if not target then
                local nextIsland = islands[RaidIslandIndex + 1]
                if nextIsland then
                    repeat
                        task.wait(1)
                    until workspace._WorldOrigin.Locations:FindFirstChild(nextIsland)
                    or not _G.Raiding
